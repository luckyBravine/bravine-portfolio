...
export default function Home() {
  ...
  if (state.succeeded) {
    return (
      <div className=" flex flex-col mx-auto w-72 my-6 p-2 rounded-lg shadow-xl">
        ...
        <Link
          href="../Profile"
          className="text-xl font-burtons text-center py-2"
        >
          Back
        </Link>
      </div>
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <main className="px-10 bg-white dark:bg-gray-900 relative overflow-hidden">
        ...
        <AnimatedSection>
          <section className="dark:bg-gray-900 animate-on-scroll">
            <div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 font-poppins">
                <div className="p-2 rounded-lg shadow-xl">
                  ...
                  <p className="px-3 py-2 text-base font-normal leading-6 text-stone-600 font-poppins dark:text-gray-300">
                    ...
                    version control, collaborate with team members, and
                ...
                <div className="p-2 rounded-lg shadow-xl">
                  ...
                  <p className="px-3 py-2 text-base font-normal leading-6 text-stone-600 font-poppins dark:text-gray-300">
                    ...
                    create a highly customizable and responsive design,
                    resulting in a sleek and professional showcase of my work.
                  </p>
                </div>
              </div>
            </div>
        ...
        <AnimatedSection>
          <section className="py-3 my-5 dark:bg-gray-900 animate-on-scroll">
            <span className="py-2 text-base font-semibold leading-8 text-gray-600 font-poppins dark:text-white">
              Projects
            </span>
        ...
        <AnimatedSection>
          <section className="dark:bg-gray-900 h-full animate-on-scroll">
            <span className="py-2 text-base font-semibold leading-8 text-gray-600 font-poppins dark:text-white">
              Let's Engage
            </span>
            <h3 className="py-1 mb-2 text-3xl font-semibold font-poppins dark:text-gray-200">
            ...
            <div className="flex flex-col justify-center mx-auto md:justify-evenly w-full md:flex-row my-2 md:my-4 dark:bg-gray-900">
              ...
              >
                ...
                <div className="flex-1 mr-0 justify-end items-end place-items-end">
                  <button
                    type="submit"
              ...
              <div className="w-full md:w-[40%] p-8 bg-stone-200 dark:bg-stone-600 dark:text-gray-200">
                ...
                <div className="flex items-end pt-12 gap-10 text-2xl text-gray-600 dark:text-gray-400">
                  <a
                    href="https://twitter.com/LuckyBravine"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <AiFillTwitterCircle />
